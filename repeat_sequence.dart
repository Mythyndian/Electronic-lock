...
class RepeatSequence extends StatefulWidget {
  @override
  _RepeatSequenceState createState() => _RepeatSequenceState();
}

class _RepeatSequenceState extends State<RepeatSequence> {
  @override
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  pinIndexSetup(String text, CodeProvider provider) {
    ...
    if (pinIndex == 4) {
      this.codeIsCorrect = (provider.code == strPin);
